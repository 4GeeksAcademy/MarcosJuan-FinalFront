            ...
            <div className="d-flex flex-wrap justify-content-center" style={{ gap: "1rem" }}>
                {store.planets.map((planet, index) => (
                    <div className="card h-100" key={index} style={{ width: "18rem", margin: "0 0.5rem" }}>
                        <img src={`https://starwars-visualguide.com/assets/img/planets/${planet.uid}.jpg`} className="card-img-top" alt={planet.name} style={{ height: "300px", objectFit: "cover" }}  onError={handleImagen}/>
